 ...
 */
public class JoyNewsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_joynew, null);
        findView(view);
        //添加Android自带的分割线
    ...
    private void findView(View view) {
        ...
        String url = "http://apicloud.mob.com/wx/article/search?page=1&cid=12&" + "&key=" + StaticClass.NEWS_KEY + "&size=60";
